...
WebUI.callTestCase(findTestCase('Demoblaze/AddtoCart'), [('variable') : ''], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Country_country'), 'Malaysia')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_City_city'), 'KL')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), '00')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Month_month'), '6')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Year_year'), '2021')
